...
function CreativesDept() {
    const location = useLocation();
    const navigate = useNavigate();
    const activeDepartment = location.state?.activeDepartment || 'Creatives';
    ...
    return (
        <Container fluid className="teamsContainer">
            <Row className="position-relative">
                ...
                {/* Overlay */}
                <div className="creativesOverlay"></div>
                
            </Row>
            <Row className="teamsText">
                <div className='text-align-center'>
                    <h1 className='deptheader my-3'>{activeDepartment} Board</h1>
                    <h5 className='deptOverview mt-3 px-5'>Plans and implements engaging marketing and communication strategies, enhancing the organization's brand presence and community.</h5>
                </div>
            </Row>
            ...
            <Row className='teamMembers'>
                <Col lg={4}>
                    ...
                    <h5 className='creatMember'>Organization Adviser</h5>
                </Col>
                <Col lg={4}> 
                    <img src={maamAbaya} alt="Members" className="membersPic" />
                    <h4 className='memberName'>Shiela Abaya</h4>

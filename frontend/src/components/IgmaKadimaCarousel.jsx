...
const EventCarousel = () => {
  ...
  const getClassName = (index) => {
    ...
    switch (position) {
      case 0:
        return 'igma-carousel-items igma-items-1';
      case 1:
        return 'igma-carousel-items igma-items-2';
      case 2:
        return 'igma-carousel-items igma-items-3';
      case 3:
        return 'igma-carousel-items igma-items-4';
      default:
        return ''; 
    }
  };
  ...
  return (
    <div className="container-fluid">
      <div className="row justify-content-center">
        <div className="igma-carousel col-12 d-flex justify-content-center align-items-center">
